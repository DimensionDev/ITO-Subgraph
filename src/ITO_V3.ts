...
export class ITO_V3__check_availabilityResult {
...
export class ITO_V3 extends ethereum.SmartContract {
  static bind(address: Address): ITO_V3 {
    return new ITO_V3("ITO_V3", address);
  }
  ...
  check_availability(id: Bytes): ITO_V3__check_availabilityResult {
    ...
    return new ITO_V3__check_availabilityResult(
  ...
  try_check_availability(
    id: Bytes
  ): ethereum.CallResult<ITO_V3__check_availabilityResult> {
    ...
    return ethereum.CallResult.fromValue(
      new ITO_V3__check_availabilityResult(
